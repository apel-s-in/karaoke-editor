...
applyVerticalZoom(){
  ...
  this.ui.playhead.style.height=(wh+30+totalH+60)+'px'; // Ограничиваем высоту плейхеда по трекам
...
showContextMenu(e){
  ...
  if(item&&!this.selected.ids.has(this.context.itemId))this.selectItem(this.context.trackId,this.context.itemId);
